...
func NewExtractValue(x Value, indices ...uint64) *InstExtractValue {
...
func (inst *InstExtractValue) Type() Type {
...
func NewInsertValue(x, elem Value, indices ...uint64) *InstInsertValue {
...
// Type returns the type of the instruction.
func (inst *InstInsertValue) Type() Type {
	// Cache type if not present.
	if inst.Typ == nil {
