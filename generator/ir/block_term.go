...
// on the given return  A nil return value indicates a void return.
func (block *Block) NewRet(x Value) *TermRet {
	term := NewRet(x)
	block.Term = term
	return term
}
...
// basic blocks.
func (block *Block) NewCondBr(cond Value, targetTrue, targetFalse *Block) *TermCondBr {
...
// cases.
func (block *Block) NewSwitch(x Value, targetDefault *Block, cases ...*Case) *TermSwitch {
...
func (block *Block) NewIndirectBr(addr Constant, validTargets ...*Block) *TermIndirectBr {
...
func (block *Block) NewInvoke(invokee Value, args []Value, normalRetTarget, exceptionRetTarget *Block) *TermInvoke {
...
func (block *Block) NewCallBr(callee Value, args []Value, normalRetTarget *Block, otherRetTargets ...*Block) *TermCallBr {
...
func (block *Block) NewResume(x Value) *TermResume {
	term := NewResume(x)
	block.Term = term
	return term
}
...
func (block *Block) NewCatchSwitch(parentPad Value, handlers []*Block, defaultUnwindTarget *Block) *TermCatchSwitch {
