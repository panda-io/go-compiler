...
define void @global.counter.destroy(i8* nocapture %this, i1 %free) #0 {
entry:
...
; Function Attrs: nofree norecurse nounwind
define void @global.counter.release_shared(i8* nocapture %this) #1 {
entry:
  %0 = getelementptr i8, i8* %this, i64 8
  %1 = bitcast i8* %0 to i32*
  %2 = load i32, i32* %1, align 4
...
; Function Attrs: nounwind
define void @global.counter.release_weak(i8* nocapture %this) #0 {
entry:
  %0 = getelementptr i8, i8* %this, i64 12
  %1 = bitcast i8* %0 to i32*
  %2 = load i32, i32* %1, align 4
