...
; Function Attrs: nofree nounwind
define void @global.base_class.do(i8* nocapture readnone %this) #0 {
entry:
...
; Function Attrs: nofree nounwind
define void @global.derive_class.do(i8* nocapture readnone %this) #0 {
entry:
  %0 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([21 x i8], [21 x i8]* @string.b58017d6f5ff15cba2431d7ec3967243, i64 0, i64 0)) #1
  %1 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @string.7cf7144b5f7d7f8893615fa04d42f3f7, i64 0, i64 0))
  ret void
}
